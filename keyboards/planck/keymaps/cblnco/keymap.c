...
[_MOBILITY] = LAYOUT_planck_grid(
    _______, KC_VOLD, KC_UP,   KC_VOLU,  _______, _______, _______, _______, KC_HOME, KC_UP,   KC_END,   _______,
    _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______,
